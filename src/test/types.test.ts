    ...
    describe('ProcessConfig', () => {
        it('should define required groovyPath, evalScriptPath, and cwd', () => {
            const config: ProcessConfig = {
                ...
                evalScriptPath: '/path/to/Eval.groovy',
                cwd: '/workspace'
            };
            assert.strictEqual(config.groovyPath, '/usr/bin/groovy');
            assert.strictEqual(config.evalScriptPath, '/path/to/Eval.groovy');
        ...
        it('should support spreading to create derived configs', () => {
            ...
            assert.strictEqual(fullConfig.evalScriptPath, '/path/to/Eval.groovy');
